...
contract LPTokenWrapper is Ownable {
    ...
    IERC20 private BAND_ETH_FLP = IERC20(0x7E9D6a38D715151dEDf21f1152f1D27a002a0EBa); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        BAND_ETH_FLP.safeTransferFrom(msg.sender, address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[msg.sender] = _balances[msg.sender].sub(amount);
        BAND_ETH_FLP.safeTransfer(msg.sender, amount);
    }
}
//-----------------------------------------------------------------------
  // --------------------| REWARD AMOUNT: 7500 |-----------------------
//-----------------------------------------------------------------------
contract BAND_PARTY_Pool is LPTokenWrapper {
    ...
    modifier checkStart(){
        require(block.timestamp >= starttime,"BAND_PARTY_Pool not started yet.");
        _;
    }

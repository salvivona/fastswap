...
contract LPTokenWrapper is Ownable {
    ...
    IERC20 private KP3R_ETH_FLP = IERC20(0x4b84Fe9c39F535002d56CA866fcc6243C3d31d65); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        KP3R_ETH_FLP.safeTransferFrom(msg.sender, address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[msg.sender] = _balances[msg.sender].sub(amount);
        KP3R_ETH_FLP.safeTransfer(msg.sender, amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 7500 |-----------------------
//-----------------------------------------------------------------------
contract KP3R_BULL_Pool is LPTokenWrapper {
    ...
    modifier checkStart(){
        require(block.timestamp >= starttime,"KP3R BULL_Pool not started yet.");
        _;
    }

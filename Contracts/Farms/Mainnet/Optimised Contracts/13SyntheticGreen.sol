...
contract LPTokenWrapper is Ownable {
    ...
    IERC20 public SNX_ETH_FLP = IERC20(0x71288fBb8b81a7a66F0DbD96BB0a6871Eac2DCCC); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        SNX_ETH_FLP.safeTransferFrom(msg.sender, address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[msg.sender] = _balances[msg.sender].sub(amount);
        SNX_ETH_FLP.safeTransfer(msg.sender, amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 7500 |-----------------------
//-----------------------------------------------------------------------
contract SYNTHETIC_GREEN_Pool is LPTokenWrapper {
    ...
    modifier checkStart(){
        require(block.timestamp >= starttime,"SYNTHETIC GREEN_Pool not started yet.");
        _;
    }

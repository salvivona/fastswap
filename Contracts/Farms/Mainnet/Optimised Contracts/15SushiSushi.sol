...
contract LPTokenWrapper is Ownable {
    ...
    IERC20 private SUSHI_ETH_FLP = IERC20(0x6B3595068778DD592e39A122f4f5a5cF09C90fE2); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        SUSHI_ETH_FLP.safeTransferFrom(msg.sender, address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[_msgSender()] = _balances[_msgSender()].sub(amount);
        SUSHI_ETH_FLP.safeTransfer(_msgSender(), amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 7500 |-----------------------
//-----------------------------------------------------------------------
contract SUSHI_SUSHI_Pool is LPTokenWrapper {
    ...
    modifier checkStart(){
        require(block.timestamp >= starttime,"SUSHI SUSHI_Pool not started yet.");
        _;
    }

...
contract LPTokenWrapper is Ownable {
    ...
    IERC20 private AAVE_ETH_FLP = IERC20(0x32ee93746D08ec72F8649645c22Feb65A0e4ed5c); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        AAVE_ETH_FLP.safeTransferFrom(msg.sender, address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[msg.sender] = _balances[msg.sender].sub(amount);
        AAVE_ETH_FLP.safeTransfer(msg.sender, amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 7500 |-----------------------
//-----------------------------------------------------------------------
contract AAVE_JUICY_Pool is LPTokenWrapper {
    ...
    modifier checkStart(){
        require(block.timestamp >= starttime,"AAVE_JUICY_Pool not started yet.");
        _;
    }

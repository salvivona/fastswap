...
contract LPTokenWrapper is IRewardDistributionRecipient {
    ...
    IERC20 public TETHER_ETH_FLP = IERC20(0x9147Cceb47E5D4759a26C9B96C22C872DaDa0415); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        TETHER_ETH_FLP.safeTransferFrom(_msgSender(), address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[_msgSender()] = _balances[_msgSender()].sub(amount);
        TETHER_ETH_FLP.safeTransfer(_msgSender(), amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 5000 |-----------------------
//-----------------------------------------------------------------------
contract TETHER_MINT_Pool is LPTokenWrapper {

...
contract LPTokenWrapper {
    ...
    IERC20 public FAST_ETH_FLP = IERC20(0x87AFC6875FbaC9c00c13bfe5403F8490bce9D890); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        FAST_ETH_FLP.safeTransferFrom(msg.sender, address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[msg.sender] = _balances[msg.sender].sub(amount);
        FAST_ETH_FLP.safeTransfer(msg.sender, amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 100,000 |-----------------------
//-----------------------------------------------------------------------
contract FAST_GANG_Pool is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public fast = IERC20(0x65fC94d99Cb301C5630c485D312e6Ff5EDdE13d0);
    uint256 public constant DURATION = 26 weeks;  //-----| Ending |--------

    uint256 public starttime = 1608310544;       //-----| DD-MM-YYYY |-----
    ...
    function collectRewardAmount() public onlyOwner {
            fast.safeTransfer(msg.sender, fast.balanceOf(address(this)));
    }
    ...
    function getReward() public updateReward(msg.sender) checkStart {
        ...
        if (reward > 0) {
            ...
            fast.safeTransfer(msg.sender, trueReward);

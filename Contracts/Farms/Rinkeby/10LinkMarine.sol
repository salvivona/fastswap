...
contract LPTokenWrapper is IRewardDistributionRecipient {
    ...
    IERC20 public LINK_ETH_FLP = IERC20(0xaCE96EB3be75F25549E3721A94ADc7B80C4B1d00); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        LINK_ETH_FLP.safeTransferFrom(_msgSender(), address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[_msgSender()] = _balances[_msgSender()].sub(amount);
        LINK_ETH_FLP.safeTransfer(_msgSender(), amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 7500 |-----------------------
//-----------------------------------------------------------------------
contract LINK_MARINE_Pool is LPTokenWrapper {
    ...
    modifier checkStart(){
        require(block.timestamp >= starttime,"LINK MARINE_Pool not started yet.");
        _;
    }

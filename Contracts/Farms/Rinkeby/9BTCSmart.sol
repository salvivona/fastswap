...
contract LPTokenWrapper is IRewardDistributionRecipient {
    ...
    IERC20 public WBTC_ETH_FLP = IERC20(0x27cAEbe73b34d47349276835ddeCd083d9c8cae2); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        WBTC_ETH_FLP.safeTransferFrom(_msgSender(), address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[_msgSender()] = _balances[_msgSender()].sub(amount);
        WBTC_ETH_FLP.safeTransfer(_msgSender(), amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 7500 |-----------------------
//-----------------------------------------------------------------------
contract BTC_SMART_Pool is LPTokenWrapper {
    ...
    modifier checkStart(){
        require(block.timestamp >= starttime,"BTC_SMART_Pool not started yet.");
        _;
    }

...
contract LPTokenWrapper is IRewardDistributionRecipient {
    ...
    IERC20 public FAST_RFI_FLP = IERC20(0x07b513313452d4078D5Cd9Ba8b8A72b6628cb009); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        FAST_RFI_FLP.safeTransferFrom(_msgSender(), address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[_msgSender()] = _balances[_msgSender()].sub(amount);
        FAST_RFI_FLP.safeTransfer(_msgSender(), amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 10,000 |-----------------------
//-----------------------------------------------------------------------
contract RFI_INTER_Pool is LPTokenWrapper {
    ...
    modifier checkStart(){
        require(block.timestamp >= starttime,"RFI_INTER_Pool not started yet.");
        _;
    }

...
contract LPTokenWrapper is IRewardDistributionRecipient {
    ...
    IERC20 public COMP_ETH_FLP = IERC20(0xD599816A8ec5Ab9869b20Cfa4722a793ba9F5d4a); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        COMP_ETH_FLP.safeTransferFrom(_msgSender(), address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[_msgSender()] = _balances[_msgSender()].sub(amount);
        COMP_ETH_FLP.safeTransfer(_msgSender(), amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 7500 |-----------------------
...
contract COMPOUND_JUICY_Pool is LPTokenWrapper {
    IERC20 public fast = IERC20(0x1A10441CDBc47762DAAfcFD18A30f57dE480D159);
    uint256 public constant DURATION = 26 weeks;  //-----| Ending |--------

    uint256 public starttime = 1611924096;       //-----| DD-MM-YYYY |-----

...
contract LPTokenWrapper is IRewardDistributionRecipient {
    ...
    IERC20 public YFI_ETH_FLP = IERC20(0x76B9126E5A4a89bfd13977D458B3a6CF01983E5a); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        YFI_ETH_FLP.safeTransferFrom(_msgSender(), address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[_msgSender()] = _balances[_msgSender()].sub(amount);
        YFI_ETH_FLP.safeTransfer(_msgSender(), amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 7500 |-----------------------
//-----------------------------------------------------------------------
contract YFI_WHALE_Pool is LPTokenWrapper {
    ...
    modifier checkStart(){
        require(block.timestamp >= starttime,"YFI_WHALE_Pool not started yet.");
        _;
    }

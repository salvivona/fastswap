...
contract LPTokenWrapper is IRewardDistributionRecipient {
    ...
    IERC20 public YFT_ETH_FLP = IERC20(0x2E7Ec9e601cDD517f9C8E3F3C824fb25d3d6Af17); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        YFT_ETH_FLP.safeTransferFrom(_msgSender(), address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[_msgSender()] = _balances[_msgSender()].sub(amount);
        YFT_ETH_FLP.safeTransfer(_msgSender(), amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 25,000 |-----------------------
//-----------------------------------------------------------------------
contract YFT_PARTY_Pool is LPTokenWrapper {
    ...
    modifier checkStart(){
        require(block.timestamp >= starttime,"YFT_PARTY_Pool not started yet.");
        _;
    }

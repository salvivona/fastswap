...
contract LPTokenWrapper is IRewardDistributionRecipient {
    ...
    IERC20 public USDC_ETH_FLP = IERC20(0xaCCe71B5247Fd131e7d91e28f7CaAcd8676CD32f); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        USDC_ETH_FLP.safeTransferFrom(_msgSender(), address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[_msgSender()] = _balances[_msgSender()].sub(amount);
        USDC_ETH_FLP.safeTransfer(_msgSender(), amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 5000 |-----------------------
//-----------------------------------------------------------------------
contract STINGY_JOE_Pool is LPTokenWrapper {
    ...
    modifier checkStart(){
        require(block.timestamp >= starttime,"STINGY_JOE_Pool not started yet.");
        _;
    }

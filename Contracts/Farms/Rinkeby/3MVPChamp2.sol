...
contract LPTokenWrapper is IRewardDistributionRecipient {
    ...
    IERC20 public MVP_ETH_FLP = IERC20(0xAd2e6F424a1b53f54530cBA68F47026F5FC7e2d0); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        MVP_ETH_FLP.safeTransferFrom(_msgSender(), address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[_msgSender()] = _balances[_msgSender()].sub(amount);
        MVP_ETH_FLP.safeTransfer(_msgSender(), amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 25,000 |-----------------------
//-----------------------------------------------------------------------
contract MVP_CHAMP_Pool is LPTokenWrapper {
    ...
    modifier checkStart(){
        require(block.timestamp >= starttime,"MVP CHAMP_Pool not started yet.");
        _;
    }

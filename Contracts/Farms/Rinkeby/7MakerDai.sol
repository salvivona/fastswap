...
contract LPTokenWrapper is IRewardDistributionRecipient {
    ...
    IERC20 public DAI_ETH_FLP = IERC20(0xE061e5b864B1dC9DA13E47287B94CDc5e4291FD6); //--|FLP|--
    ...
    function stake(uint256 amount) public {
        ...
        DAI_ETH_FLP.safeTransferFrom(_msgSender(), address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[_msgSender()] = _balances[_msgSender()].sub(amount);
        DAI_ETH_FLP.safeTransfer(_msgSender(), amount);
    }
}
//-----------------------------------------------------------------------
// --------------------| REWARD AMOUNT: 5000 |-----------------------
//-----------------------------------------------------------------------
contract MAKER_DAI_Pool is LPTokenWrapper {

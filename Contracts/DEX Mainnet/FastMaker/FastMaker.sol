...
// T1 - T4: OK
contract FastMaker is BoringOwnable {
    ...
    constructor (address _factory, address _bar, address _fast, address _weth) public {
    ...
    function setBridge(address token, address bridge) external onlyOwner {
        // Checks
        require(token != sushi && token != weth && token != bridge, "FastMaker: Invalid bridge");
    ...
    modifier onlyEOA() {
        ...
        require(msg.sender == tx.origin, "FastMaker: must use EOA");
        _;
    }
    ...
    function _convert(address token0, address token1) internal {
        ...
        require(address(pair) != address(0), "FastMaker: Invalid pair");
        // balanceOf: S1 - S4: OK
        // transfer: X1 - X5: OK
    ...
    function _swap(address fromToken, address toToken, uint256 amountIn, address to) internal returns (uint256 amountOut) {
        ...
        require(address(pair) != address(0), "FastMaker: Cannot convert");

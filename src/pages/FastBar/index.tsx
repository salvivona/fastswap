...
const FastBar = () => {
  ...
  const checkApprove2Amt = (e:any) => {
    ...
    if (value) {
      ...
      enqueueSnackbar('Type an amount.', { variant : "info" });
    }
  }
  const onClickApprove2 = async () => {
    if (approve2form.amount === '' || approve2form.value === 0 || approve2form.amount === '0') {
      enqueueSnackbar('Type an amount.', { variant : "info" });
      return;
    } else {
  ...
  const onClickStack2 = async () => {
    if (stake2form.amount === '' || stake2form.amount === '0' || stake2form.value === 0) {
      enqueueSnackbar('Type an amount.', { variant : "info" });
      return;
    } else {
  ...
  const onClickLeave = async () => {
    if (leaveform.amount === '' || leaveform.amount === '0' || leaveform.value === 0) {
      enqueueSnackbar('Type an amount.', { variant : "info" });
      return;
    } else {
